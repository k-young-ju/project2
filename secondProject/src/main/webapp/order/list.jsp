		...
		<td width=600 rowspan=3 style="vertical-align:top;">
			...
			<table style="background-color: white;border:2px solid #8D0837;border-radius: 15px;vertical-align:top;" border=0>
				...
				<tr height=20>
					...
					<td width=20></td>
					<td width=500>
						<input id="od_name" name="od_name" style="width:400px;height:35px;padding-left: 10px" placeholder="${m.name }" value="${m.name }">
					</td>
					<td width=100></td>
				</tr>
				...
				<tr height=20>
					...
					<td width=500>
						<c:set var="hi" value="-" />
						<input value="${m.phone1 }${m.phone2 }${m.phone3 }" placeholder="${m.phone1 } ${hi } ${m.phone2 } ${hi } ${m.phone3 }" name="od_phone" id="od_phone" type="text" maxlength="12" style="width:400px;height:35px;padding-left: 10px" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />			
					</td>
					<td width=200></td>
				</tr>
				<tr height=20></tr>
			...
			<table style="background-color: white;border:2px solid #8D0837;border-radius: 15px;" border=0>
				...
				<tr height=20>
					...
					<td width=500>
					<c:set var="hi" value="-" />
						<input type="text"maxlength="12" style="width:400px;height:35px;padding-left: 10px" id="od_b_phone" name="od_b_phone" placeholder="전화번호를 입력해주세요." onkeyup="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
					</td>
					<td width=200></td>
				</tr>
				<tr height=20></tr>
					...
					<td style="vertical-align:top;">
						<table border=0 width=350 style="border:2px solid #8D0837;vertical-align:top;" height=150>
							...
							<c:choose>
									...
									<c:otherwise>
										<td style="width:175px;border:2px solid #8D0837;text-align:center;" colspan=2>주문금액<br><fmt:formatNumber value="${totals }"/></td>
										<td style="width:175px;border:2px solid #8D0837;text-align:center;">이용가능 포인트<br><fmt:formatNumber value="${num2 }"/></td>
									</c:otherwise>	
							</c:choose>
							...
							<tr>
								<td>&nbsp;&nbsp;적립예정P</td>
								<td></td>
								<td style="text-align:right;"><fmt:formatNumber value="${totals / 100}"/>&nbsp;&nbsp;</td>
							</tr>
							<tr height=15/>
							</c:otherwise>
							</c:choose>
							...
							<c:choose>
								...
								<c:otherwise>
									<tr>
										...
										<td></td>
										<td style="text-align:right;">&nbsp;
											<input id="point2" name="point2" value="0" style="width:100px;" maxlength=7>P&nbsp;&nbsp;
											<input type="hidden" id="point1" value="0" name="point1" style="width:100px;">
										</td>
									</tr>
									...
									<tr>
										<td></td>
										<td colspan=2 style="text-align:right;font-size:15px;">1000P단위 사용가능&nbsp;&nbsp;</td>		
									</tr>						
									<tr height=15/>	
								</c:otherwise>
							</c:choose>	
		...
		document.getElementById('depositPassbook').style.display='inline';
			...
			<table id="depositPassbook" style="display:none;" width=350 border=0>
				...
				<tr>
					...
					<td width=250><input id="depositor" name="depositor"></td>
				</tr>
				<tr height=10></tr>		
			</table>			
