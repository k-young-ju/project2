	...
	<tr>
		...
		<c:choose>
			<c:when test="${sessionScope.m_id == null }">
				<td width=100 align=right><a href="/member/login"><img src ="/img/log-in.png" style="width:60px;height:50px;">&nbsp;&nbsp;</a></td>
				<td width=100 align=center><a href="/member/join"><img src ="/img/signup.png" style="width:60px;height:50px;">&nbsp;&nbsp;</a></td>
			...
			<c:otherwise>
				...
				<td width=80 align=center><a href="/member/logout"><img src ="/img/shutdown.png" style="width:50px;height:40px;">&nbsp;&nbsp;</a></td>
				<td width=80 height=50 align=center  class="cart_img" onclick="location.href='/cart/list'">
					<div class="cart_img2">
						<span id="cartNum" name="cartNum" style="color: white;vertical-align: middle;">${cartNum }</span>
					</div>
