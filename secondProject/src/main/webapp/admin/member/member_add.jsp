...
<table border=0>
	<tr>
		<td><a href="/admin"><img src = "/img/Logo5.png" style="width:615px;height:170px"> </a></td>
	</tr>
</table>
<form name="add" action="add" method="post" onsubmit="return join_ok()">
<table width =600 border=0>
	...
	<tr>
		<td>
			<input id="m_id" name="m_id" onkeyup="id_check(add.m_id.value)" class="input_style">
	...
	<tr>
		<td><input id="m_pass" name="m_pass" class="input_style"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>
			<input id="m_pass2" name="m_pass2" onkeyup="pass_check()" class="input_style">
	...
	<tr>
		<td><h2 class="name_style">회원등급</h2></td>
	</tr>
	<tr>
		<td><input id="level" name="level" class="input_style"></td>
	</tr>	
	<tr>
	...
	<tr>
		<td>
			<input id="email1" name="email1"  style="width:40%;height:25px"> @
			<select id = "email2" name="email2"  style="width:40%;height:25px">
...
<table width=600>
	<tr>
		<td align="center" style="width:100%"><button style="width:100%;height:30px"><b style="font-size: 20px">가입하기</b></button></td>
	</tr>
</table>
</form>
</center>
