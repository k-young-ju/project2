...
<table width=800 style="border:0px;" border=1>
	<tr height=15/>
	<tr>
		<td width=187 style="background-color:#5055B1;color:white;text-align:center;">상품분류 </td>
			<td width=688 style="padding-left:20px;">
...
<form name="sell_used" action="sell_used" method="post" enctype="multipart/form-data" onsubmit="return sell_used_go()">
	<table width=800 border=0>
		<tr>
			<td width=160 style="background-color:#5055B1;color:white;text-align:center;">대표 이미지
					<input type="hidden" name="location" value="<%=location %>">
		...
		<td style="border:0px solid #5055B1"><input name="n_book" class="input_style" style="width:100%;height:27px;font-size:15px;border:1px solid #2323EF;border-radius:0px;"></td>
	</tr>
		<tr height=15></tr>
		<tr>
			<td style="background-color:#5055B1;color:white;text-align:center;">가격</td>
			<td style="border:0px solid #5055B1">
				<input type="number" id="price4" name="price4" style="width:99%;height:27px;font-size:15px;border:1px solid #2323EF;border-radius:0px;"></td>
		...
		<tr height=15></tr>
		<tr>
			<td colspan="2" style="background-color:#5055B1;color:white;vertical-align:middle;">상세설명 <br><textarea placeholder="상품설명" style="width:99%;height:300px;border:1px solid #5055B1;outline:none;" name="comment"></textarea></td>
		</tr>
		<tr height=15></tr>
	</table>
	<table height=20 />
